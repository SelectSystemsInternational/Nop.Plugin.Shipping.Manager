...
namespace CanadaPostApi.Api
{
    ...
    public interface ITrackingApi : IApiAccessor
    {
        ...
        /// <param name="errors">Errors</param>
        /// <returns>Tracking details</returns>
        public trackingsummary GetTrackingSummary(string destinationPostalCode, string referenceNumber, string pin, string from, string to, out string errors);
    ...
    public partial class TrackingApi : ITrackingApi
    {
        ...
        public trackingsummary GetTrackingSummary(string destinationPostalCode, string referenceNumber, string pin, string from, string to, out string errors)
        {
            ...
            // PIN Summary URI
            //var url = "https://ct.soa-gw.canadapost.ca/vis/track/pin/9844725396479320/summary";
            // DNC Summary URI
            ...
            if (pin != null)
            {
                url = $"{Configuration.ApiClient.Configuration.BasePath}/vis/track/pin/" + pin + "/summary/";
            }
            else
            {
                url = $"{Configuration.ApiClient.Configuration.BasePath}/vis/track/ref/summary?mailingDateTo={to}&mailingDateFrom={from}" +
