...
namespace SendCloudApi.Net.Resources
{
    ...
    {
        protected readonly SendCloudApi _client;
        protected readonly string _hostUrl = " https://servicepoints.sendcloud.sc/api/v2/";
        protected readonly string _dateTimeFormat = "yyyy-MM-dd HH:mm:ss";
