...
namespace Sharp3DBinPacking.Algorithms
{
    ...
    {
        protected readonly BinPackParameter _parameter;
        protected readonly FreeRectChoiceHeuristic _rectChoice;
        protected readonly GuillotineSplitHeuristic _splitMethod;
        protected readonly ShelfChoiceHeuristic _shelfChoice;
        // stores the starting y coordinate of the latest(topmost) shelf
        private decimal _currentY;
        protected readonly IList<Shelf> _shelves;
        protected readonly IList<Cuboid> _packedCuboids;
