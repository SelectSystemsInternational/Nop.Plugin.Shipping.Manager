...
{
    public partial class ShippingOperationsController : BaseAdminController
    {
        ...
        protected readonly IShippingOperationsModelFactory _shippingOperationsModelFactory;
        ...
        public ShippingOperationsController(IAddressService addressService,
            ...
            IShippingOperationsModelFactory shippingOperationsModelFactory,
            ...
            IShippingManagerService shippingManagerService)
        {
            ...
            _shippingOperationsModelFactory = shippingOperationsModelFactory;
        ...
        protected virtual async Task UpdateLocalesAsync(CutOffTime cutOffTime, CutOffTimeModel model)
        {
            foreach (var localized in model.Locales)
                await _localizedEntityService.SaveLocalizedValueAsync(cutOffTime, x => x.Name, localized.Name, localized.LanguageId);
        }
        ...
        public virtual async Task<IActionResult> PickupPointProviders()
        {
            ...
            //prepare model
            var model = _shippingOperationsModelFactory.PreparePickupPointProviderSearchModel(new PickupPointProviderSearchModel());

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/PickupPointProviders.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> PickupPointProviders(PickupPointProviderSearchModel searchModel)
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PreparePickupPointProviderListModelAsync(searchModel);
        ...
        public virtual async Task<IActionResult> Methods()
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareShippingMethodSearchModelAsync(new ShippingMethodSearchModel());

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/Methods.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> Methods(ShippingMethodSearchModel searchModel)
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareShippingMethodListModelAsync(searchModel);
        ...
        public virtual async Task<IActionResult> CreateMethod()
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareShippingMethodModelAsync(new ShippingMethodModel(), null);

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/CreateMethod.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> CreateMethod(ShippingMethodModel model, bool continueEditing)
        {
            ...
            //prepare model
            model = await _shippingOperationsModelFactory.PrepareShippingMethodModelAsync(model, null, true);
        ...
        public virtual async Task<IActionResult> EditMethod(int id)
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareShippingMethodModelAsync(null, shippingMethod);

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/EditMethod.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> EditMethod(ShippingMethodModel model, bool continueEditing)
        {
            ...
            //prepare model
            model = await _shippingOperationsModelFactory.PrepareShippingMethodModelAsync(model, shippingMethod, true);
        ...
        public virtual async Task<IActionResult> DatesAndRanges()
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareDatesRangesSearchModelAsync(new DatesRangesSearchModel());

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/DatesAndRanges.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> DeliveryDates(DeliveryDateSearchModel searchModel)
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareDeliveryDateListModelAsync(searchModel);
        ...
        public virtual async Task<IActionResult> CreateDeliveryDate()
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareDeliveryDateModelAsync(new DeliveryDateModel(), null);

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/CreateDeliveryDate.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> CreateDeliveryDate(DeliveryDateModel model, bool continueEditing)
        {
            ...
            //prepare model
            model = await _shippingOperationsModelFactory.PrepareDeliveryDateModelAsync(model, null, true);
        ...
        public virtual async Task<IActionResult> EditDeliveryDate(int id)
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareDeliveryDateModelAsync(null, deliveryDate);

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/EditDeliveryDate.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> EditDeliveryDate(DeliveryDateModel model, bool continueEditing)
        {
            ...
            //prepare model
            model = await _shippingOperationsModelFactory.PrepareDeliveryDateModelAsync(model, deliveryDate, true);
        ...
        public virtual async Task<IActionResult> ProductAvailabilityRanges(ProductAvailabilityRangeSearchModel searchModel)
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareProductAvailabilityRangeListModelAsync(searchModel);
        ...
        public virtual async Task<IActionResult> CreateProductAvailabilityRange()
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareProductAvailabilityRangeModelAsync(new ProductAvailabilityRangeModel(), null);

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/CreateProductAvailabilityRange.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> CreateProductAvailabilityRange(ProductAvailabilityRangeModel model, bool continueEditing)
        {
            ...
            //prepare model
            model = await _shippingOperationsModelFactory.PrepareProductAvailabilityRangeModelAsync(model, null, true);
        ...
        public virtual async Task<IActionResult> EditProductAvailabilityRange(int id)
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareProductAvailabilityRangeModelAsync(null, productAvailabilityRange);

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/EditProductAvailabilityRange.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> EditProductAvailabilityRange(ProductAvailabilityRangeModel model, bool continueEditing)
        {
            ...
            //prepare model
            model = await _shippingOperationsModelFactory.PrepareProductAvailabilityRangeModelAsync(model, productAvailabilityRange, true);
        ...
        [HttpPost]
        public virtual async Task<IActionResult> CutOffTime(CutOffTimeSearchModel searchModel)
        {
            if (!await _shippingManagerService.AuthorizeAsync(SystemHelper.AccessMode.Manage))
                return AccessDeniedView();

            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareCutOffTimeListModelAsync(searchModel);

            return Json(model);
        }

        public virtual async Task<IActionResult> CreateCutOffTime()
        {
            if (!await _shippingManagerService.AuthorizeAsync(SystemHelper.AccessMode.Manage))
                return AccessDeniedView();

            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareCutOffTimeModelAsync(new CutOffTimeModel(), null);

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/CreateCutOffTime.cshtml", model);
        }

        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
        public virtual async Task<IActionResult> CreateCutOffTime(CutOffTimeModel model, bool continueEditing)
        {
            if (!await _shippingManagerService.AuthorizeAsync(SystemHelper.AccessMode.Manage))
                return AccessDeniedView();
            ...
            if (ModelState.IsValid)
            {
                var cutOffTime = model.ToEntity<CutOffTime>();
                await _carrierService.InsertCutOffTimeAsync(cutOffTime);

                //locales
                await UpdateLocalesAsync(cutOffTime, model);

                _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Plugins.Shipping.Manager.CutOffTimes.Added"));

                return continueEditing ? RedirectToAction("EditCutOffTime", new { id = cutOffTime.Id }) : RedirectToAction("DatesAndRanges");
            }

            //prepare model
            model = await _shippingOperationsModelFactory.PrepareCutOffTimeModelAsync(model, null, true);

            //if we got this far, something failed, redisplay form
            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/CreateCutOffTime.cshtml", model);
        }

        public virtual async Task<IActionResult> EditCutOffTime(int id)
        {
            if (!await _shippingManagerService.AuthorizeAsync(SystemHelper.AccessMode.Manage))
                return AccessDeniedView();

            //try to get a product availability range with the specified id
            var cutOffTime = await _carrierService.GetCutOffTimeByIdAsync(id);
            if (cutOffTime == null)
                return RedirectToAction("DatesAndRanges");

            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareCutOffTimeModelAsync(null, cutOffTime);

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/EditCutOffTime.cshtml", model);
        }

        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
        public virtual async Task<IActionResult> EditCutOffTime(CutOffTimeModel model, bool continueEditing)
        {
            if (!await _shippingManagerService.AuthorizeAsync(SystemHelper.AccessMode.Manage))
                return AccessDeniedView();

            //try to get a product availability range with the specified id
            var cutOffTime = await _carrierService.GetCutOffTimeByIdAsync(model.Id);
            if (cutOffTime == null)
                return RedirectToAction("DatesAndRanges");

            if (ModelState.IsValid)
            {
                cutOffTime = model.ToEntity(cutOffTime);
                await _carrierService.UpdateCutOffTimeAsync(cutOffTime);

                //locales
                await UpdateLocalesAsync(cutOffTime, model);

                _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Plugins.Shipping.Manager.CutOffTimes.Updated"));

                return continueEditing ? RedirectToAction("EditCutOffTime", cutOffTime.Id) : RedirectToAction("DatesAndRanges");
            }

            //prepare model
            model = await _shippingOperationsModelFactory.PrepareCutOffTimeModelAsync(model, cutOffTime, true);
        ...
        [HttpPost]
        public virtual async Task<IActionResult> DeleteCutOffTime(int id)
        {
            if (!await _shippingManagerService.AuthorizeAsync(SystemHelper.AccessMode.Manage))
                return AccessDeniedView();
            ...
            await _carrierService.DeleteCutOffTimeAsync(cutOffTime);

            _notificationService.SuccessNotification(await _localizationService.GetResourceAsync("Plugins.Shipping.Manager.CutOffTimes.Deleted"));
        ...
        public virtual async Task<IActionResult> Warehouses()
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareWarehouseSearchModelAsync(new WarehouseSearchModel());

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/Warehouses.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> Warehouses(WarehouseSearchModel searchModel)
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareWarehouseListModelAsync(searchModel);
        ...
        public virtual async Task<IActionResult> CreateWarehouse()
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareWarehouseModelAsync(new WarehouseModel(), null);

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/CreateWarehouse.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> CreateWarehouse(WarehouseModel model, bool continueEditing)
        {
            ...
            //prepare model
            model = await _shippingOperationsModelFactory.PrepareWarehouseModelAsync(model, null, true);
        ...
        public virtual async Task<IActionResult> EditWarehouse(int id)
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareWarehouseModelAsync(null, warehouse);

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/EditWarehouse.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> EditWarehouse(WarehouseModel model, bool continueEditing)
        {
            ...
            //prepare model
            model = await _shippingOperationsModelFactory.PrepareWarehouseModelAsync(model, warehouse, true);
        ...
        public virtual async Task<IActionResult> Restrictions()
        {
            ...
            //prepare model
            var model = await _shippingOperationsModelFactory.PrepareShippingMethodRestrictionModelAsync(new ShippingMethodRestrictionModel());

            return View("~/Plugins/SSI.Shipping.Manager/Views/Shipping/Restrictions.cshtml", model);
        }
