...
namespace Nop.Plugin.Shipping.Manager.Factories
{
    ...
    /// </summary>
    public partial interface IShippingOperationsModelFactory
    {
        /// <summary>
        ...
        public ShippingProviderSearchModel PrepareShippingProviderSearchModel(ShippingProviderSearchModel searchModel);
        ...
        public Task<ShippingProviderListModel> PrepareShippingProviderListModelAsync(ShippingProviderSearchModel searchModel);
        ...
        public PickupPointProviderSearchModel PreparePickupPointProviderSearchModel(PickupPointProviderSearchModel searchModel);
        ...
        public Task<PickupPointProviderListModel> PreparePickupPointProviderListModelAsync(PickupPointProviderSearchModel searchModel);
        ...
        public Task<ShippingMethodSearchModel> PrepareShippingMethodSearchModelAsync(ShippingMethodSearchModel searchModel);
        ...
        public Task<ShippingMethodListModel> PrepareShippingMethodListModelAsync(ShippingMethodSearchModel searchModel);
        ...
        public Task<ShippingMethodModel> PrepareShippingMethodModelAsync(ShippingMethodModel model,
        ...
        public Task<DatesRangesSearchModel> PrepareDatesRangesSearchModelAsync(DatesRangesSearchModel searchModel);
        ...
        public Task<DeliveryDateListModel> PrepareDeliveryDateListModelAsync(DeliveryDateSearchModel searchModel);
        ...
        public Task<DeliveryDateModel> PrepareDeliveryDateModelAsync(DeliveryDateModel model, DeliveryDate deliveryDate, bool excludeProperties = false);
        ...
        public Task<ProductAvailabilityRangeListModel> PrepareProductAvailabilityRangeListModelAsync(ProductAvailabilityRangeSearchModel searchModel);
        ...
        public Task<ProductAvailabilityRangeModel> PrepareProductAvailabilityRangeModelAsync(ProductAvailabilityRangeModel model,
        ...
        /// <param name="searchModel">Product availability range search model</param>
        /// <returns>Product availability range list model</returns>
        public Task<CutOffTimeListModel> PrepareCutOffTimeListModelAsync(CutOffTimeSearchModel searchModel);
        ...
        /// <param name="excludeProperties">Whether to exclude populating of some properties of model</param>
        /// <returns>Product availability range model</returns>
        public Task<CutOffTimeModel> PrepareCutOffTimeModelAsync(CutOffTimeModel model,
        ...
        public Task<WarehouseSearchModel> PrepareWarehouseSearchModelAsync(WarehouseSearchModel searchModel);
        ...
        public Task<WarehouseListModel> PrepareWarehouseListModelAsync(WarehouseSearchModel searchModel);
        ...
        public Task<WarehouseModel> PrepareWarehouseModelAsync(WarehouseModel model, Warehouse warehouse, bool excludeProperties = false);
        ...
        public Task<ShippingMethodRestrictionModel> PrepareShippingMethodRestrictionModelAsync(ShippingMethodRestrictionModel model);
    }
}